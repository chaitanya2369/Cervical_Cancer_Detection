...
const TrainingData = () => {
  ...
  // Sample Excel format structure (static for now, used for download reference)
  const excelFormat = {
    columns: ["PatientID", "Age", "Gender", "Diagnosis", "Date", "Result"],
    sampleData: [
      ["P001", 45, "Male", "AF", "2025-04-01", "Positive"],
      ["P002", 30, "Female", "DIC", "2025-04-02", "Negative"],
    ],
  };
