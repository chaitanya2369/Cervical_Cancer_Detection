        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              disabled={!isEditMode}
              className="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-gray-50 disabled:bg-gray-100"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              name="organisation"
              value={isEditMode ? editedData.organisation : userData.organisation}
              onChange={handleInputChange}
              disabled={!isEditMode}
              className="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-gray-50 disabled:bg-gray-100"
            />
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-500 text-sm">{userData.lastUpdated}</span>
            </div>
            <button
              onClick={() => alert("Add Email Address functionality not implemented yet")}
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-2">Can Train</label>
            <ToggleSwitch
              name="canTrain"
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-2">Can Predict</label>
            <ToggleSwitch
              name="canPredict"
              checked={isEditMode ? editedData.canPredict : userData.canPredict}
              onChange={handleInputChange}
            />
          </div>
        </div>
        ...
        {isEditMode && (
          <div className="p-6 flex justify-end space-x-4">
            <button
              onClick={() => {
                setIsEditMode(false);
                setPreviewImage(userData.profileImage); // Revert image on cancel
